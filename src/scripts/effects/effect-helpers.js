...
export default class EffectHelpers {
  ...
  createActiveEffect({
    ...
    ceFlags[CONSTANTS.DFREDS_CONVENIENT_EFFECTS_MODULE_NAME][CONSTANTS.DFREDS_CONVENIENT_EFFECTS.FLAGS.IS_VIEWABLE] =
      isViewable;
    ceFlags[CONSTANTS.DFREDS_CONVENIENT_EFFECTS_MODULE_NAME][CONSTANTS.DFREDS_CONVENIENT_EFFECTS.FLAGS.NESTED_EFFECTS] =
      nestedEffects;
  ...
  getDescription(activeEffect) {
    ...
    const flagDescription = activeEffect.getFlag(
      CONSTANTS.DFREDS_CONVENIENT_EFFECTS_MODULE_NAME,
      CONSTANTS.DFREDS_CONVENIENT_EFFECTS.FLAGS.DESCRIPTION
    );
  ...
  async updateStatusId(activeEffect) {
    ...
    let statusesArray = Array.from(statusesSet).filter((status) => !status.startsWith("Convenient Effect: "));
